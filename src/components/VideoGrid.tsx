...
const testimonials: VideoCardProps[] = [
  {
    videoSrc: '/video/testimonial-1-diamond-detailz.mp4',
    posterSrc: '/images/poster-diamond-detailz.jpg',
    clientName: 'Diamond Detailz',
    igHandle: '@diamonddetailz',
    description: 'Premium automotive detailing — Shelby Township, MI',
  },
  {
    videoSrc: '/video/testimonial-2-rpm-auto-lab.mp4',
    posterSrc: '/images/poster-rpm-auto-lab.jpg',
    clientName: 'RPM Auto Lab',
    igHandle: '@rpmautolab',
    description: 'High-end auto lab',
  },
  {
    videoSrc: '/video/testimonial-3-ascension-1.mp4',
    posterSrc: '/images/poster-ascension-1.jpg',
    clientName: 'Ascension Automotive',
    igHandle: '@ascensionautomotive',
    description: 'Luxury automotive brand',
  },
  {
    videoSrc: '/video/testimonial-4-kawi.mp4',
    posterSrc: '/images/poster-kawi.jpg',
    clientName: 'Kawi',
    igHandle: '@kawi.cavyy',
    description: 'Automotive creator',
  },
  {
    videoSrc: '/video/testimonial-5-unknown-m1k.mp4',
    posterSrc: '/images/poster-unknown-m1k.jpg',
    clientName: 'Unknown M1K',
    igHandle: '@unknown_m1k',
    description: 'Automotive filmmaker',
  },
  {
    videoSrc: '/video/testimonial-6-ascension-2.mp4',
    posterSrc: '/images/poster-ascension-2.jpg',
    clientName: 'Ascension Automotive',
    igHandle: '@ascensionautomotive',
    description: 'Luxury automotive brand',
  },
